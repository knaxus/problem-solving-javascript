...
function areIdentical(rootOfOriginalTree, rootOfMatchingTree) {
  ...
  return (
    rootOfOriginalTree.value === rootOfMatchingTree.value &&
    areIdentical(rootOfOriginalTree.leftChild, rootOfMatchingTree.leftChild) &&
    areIdentical(rootOfOriginalTree.rightChild, rootOfMatchingTree.rightChild)
  );
}
...
function isSubtree(rootOfOriginalTree, rootOfMatchingTree) {
  ...
  return (
    isSubtree(rootOfOriginalTree.leftChild, rootOfMatchingTree) ||
    isSubtree(rootOfMatchingTree.rightChild, rootOfMatchingTree)
  );
}
